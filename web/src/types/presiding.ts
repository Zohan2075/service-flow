...
function mk(d: typeof DEFAULTS[0]): PresidingSection {
  return { ...d, assigneeName: "", subsections: [], timerRoles: getDefaultTimerRoles(d) };
}
...
export function createPresidingSection(titleEn = "", titleEs = "", duration = 5, group: SectionGroup = null): PresidingSection {
  ...
  return { ...section, timerRoles: getDefaultTimerRoles(section) };
}
