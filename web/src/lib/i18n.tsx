...
const translations = {
  en: {
    ...
    "settings.monthlyCap": "Monthly Hours + Credit Cap",
    ...
    "settings.programDesc": "Configure and enable the meeting program dashboard.",
    "settings.enableProgram": "Enable Program",
    "settings.enableProgramDesc": "Show Program in navigation and enable meeting presider features.",
    "settings.chairmanExpectedCount": "Expected chairman / president count",
    "settings.chairmanExpectedCountDesc": "Set the expected number or limit shown in the Program chairman label.",
    "settings.capExceeded": "Adding this would exceed your {cap}h monthly limit ({current}/{cap}h). Save anyway?",
    ...
    "settings.notificationsDesc": "Get reminders for upcoming Interested People visits, even when the app is closed.",
    "settings.notificationsEnabled": "Interested People reminders",
    "settings.notificationsEnabledDesc": "Use browser notifications for specific and weekly future visits.",
    "settings.notificationStatus": "Browser notification status",
    "settings.notificationsUnsupported": "Notifications are not available in this browser",
    "settings.notificationsSubscribed": "Push delivery is enabled for this device",
    "settings.notificationsPermissionOnly": "Permission is granted; background push is not configured",
    "settings.notificationsBlocked": "Notifications are blocked in browser settings",
    "settings.notificationsNotEnabled": "Permission has not been granted",
    "settings.enableNotifications": "Enable",
    "settings.notificationAdvance": "Notify up to",
    "settings.notificationFrequency": "Check frequency",
    "settings.notificationSound": "Foreground sound",
    "settings.soundOff": "Off",
    "settings.soundSoft": "Soft",
    "settings.soundChime": "Chime",
    "settings.soundAlert": "Alert",
    "settings.notificationPreview": "Show visit details",
    "settings.notificationPreviewDesc": "Include the person and date in the notification.",
  ...
  es: {
    ...
    "settings.programDesc": "Configura y activa el panel del programa de la reunión.",
    "settings.enableProgram": "Activar Programa",
    "settings.enableProgramDesc": "Mostrar Programa en la navegación y activar funciones de presidente.",
    "settings.chairmanExpectedCount": "Cantidad esperada de presidentes",
    "settings.chairmanExpectedCountDesc": "Define la cantidad o límite que se muestra en la etiqueta del presidente del Programa.",
    "settings.capExceeded": "Esto excedería tu límite mensual de {cap}h ({current}/{cap}h). ¿Guardar de todos modos?",
    ...
    "settings.notificationsDesc": "Recibe recordatorios de próximas visitas, incluso cuando la aplicación esté cerrada.",
    "settings.notificationsEnabled": "Recordatorios de Estudios y Revisitas",
    "settings.notificationsEnabledDesc": "Usa notificaciones del navegador para visitas específicas y semanales.",
    "settings.notificationStatus": "Estado de notificaciones del navegador",
    "settings.notificationsUnsupported": "Las notificaciones no están disponibles en este navegador",
    "settings.notificationsSubscribed": "La entrega push está activa en este dispositivo",
    "settings.notificationsPermissionOnly": "Permiso concedido; push en segundo plano no configurado",
    "settings.notificationsBlocked": "Las notificaciones están bloqueadas en la configuración del navegador",
    "settings.notificationsNotEnabled": "Aún no se ha concedido permiso",
    "settings.enableNotifications": "Activar",
    "settings.notificationAdvance": "Avisar con hasta",
    "settings.notificationFrequency": "Frecuencia de comprobación",
    "settings.notificationSound": "Sonido en primer plano",
    "settings.soundOff": "Desactivado",
    "settings.soundSoft": "Suave",
    "settings.soundChime": "Campana",
    "settings.soundAlert": "Alerta",
    "settings.notificationPreview": "Mostrar detalles de la visita",
    "settings.notificationPreviewDesc": "Incluir la persona y la fecha en la notificación.",
