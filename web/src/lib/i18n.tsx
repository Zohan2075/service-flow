...
const translations = {
  en: {
    ...
    "settings.backupDriveDesc": "Upload current data to Google Drive",
    "settings.restoreDrive": "Restore from Drive",
    "settings.restoreDriveDesc": "Download and restore backup from Google Drive",
  ...
  es: {
    ...
    "settings.backupDriveDesc": "Subir datos actuales a Google Drive",
    "settings.restoreDrive": "Restaurar de Drive",
    "settings.restoreDriveDesc": "Descargar y restaurar respaldo de Google Drive",
